...
const Contact = () => {
  return (
    <div className="max-auto min-h-[60vh]">
        ...
        <div className="join m-6 flex justify-center">
          ...
          <button className="btn bg-neutral text-neutral-content join-item rounded-r-full">Subscribe</button>
        </div>
        
        <div className="flex justify-center">
        <div className="w-2/5 h-auto diff aspect-[16/9] ">
    <div className="diff-item-1">
    <img className="rounded-xl" src="https://images.unsplash.com/photo-1474901879171-d6f34b3a99b0?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="crying woman by Danie Franco" />
    </div>
